...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2mongodb_default_da43f632636d1e32c1be0ccf7b7258ad07ff7cac5b8c921a399aa16c83201b79');

        $c = new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\Symfony\\src\\test\\BlogBundle\\Document', 1 => 'C:\\wamp\\www\\Symfony\\src\\Acme\\StoreBundle\\Document'));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($c, 'test\\BlogBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('testBlogBundle' => 'test\\BlogBundle\\Document', 'AcmeStoreBundle' => 'Acme\\StoreBundle\\Document'));
        $instance->setMetadataCacheImpl($b);
        $instance->setMetadataDriverImpl($d);
        $instance->setProxyDir('C:/wamp/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('MongoDBODMProxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('C:/wamp/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Hydrators');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\doctrine\\mongodb-odm-bundle\\Doctrine\\Bundle\\MongoDBBundle/Resources/views', 'DoctrineMongoDB');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine_mongodb.odm.proxy_dir' => 'C:/wamp/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => 'C:/wamp/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Hydrators',
